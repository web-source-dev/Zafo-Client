...
import { Users, Activity, Calendar, TrendingUp, UserPlus, Server, Database, Clock, AlertCircle } from 'lucide-react';
import adminService from '../../services/admin-service';

// Dashboard navigation with icons
const getDashboardNavigation = (t: (key: string) => string) => [
  { name: t('admin.overview'), href: '/admin', icon: DashboardIcon, current: true },
  { name: t('admin.userManagement'), href: '/admin/users', icon: UsersIcon, current: false },
